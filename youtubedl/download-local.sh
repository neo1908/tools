...
OPTS="--restrict-filenames -a ./channels.lst --write-description --write-info-json --write-annotations --write-thumbnail --all-subs --audio-quality 0 -o ${FORMAT} --download-archive ${ARCHIVE_FILE}"
